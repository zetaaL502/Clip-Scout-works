...
// Accepts a Pexels CDN URL, fetches it server-side, runs it through FFmpeg to
// produce a proper MP4 with correct duration metadata, and streams it back.
// Raw Pexels files can have fragmented moov atoms with broken duration — FFmpeg
// rewrites the container with +faststart, fixing the metadata for editing apps.
